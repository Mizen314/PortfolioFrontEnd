package com.emmanuel.portfolio.security.config;
import com.emmanuel.portfolio.security.jwt.JwtAuthEntryPoint;
import com.emmanuel.portfolio.security.jwt.JwtRequestFilter;
import com.emmanuel.portfolio.security.service.UserDetailsServiceImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().and().csrf().disable()
                ...
                //Esta linea es de autorizar de onda los puntos xq no puedo terminar de armarlo
                .authorizeRequests().antMatchers("/api/persona/1",
                "/api/experiencia/**",
                "/api/estudio/**",
                "/api/tecnologia/**").permitAll()
                //Es para separar la anteior
